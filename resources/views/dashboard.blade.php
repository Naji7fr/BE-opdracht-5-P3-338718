                        ...
                        <a href="{{ route('allergenen.index') }}"
                           class="block p-6 bg-amber-50 hover:bg-amber-100 border border-amber-200 rounded-lg transition-colors duration-200">
                            <div class="flex items-center">
                                ...
                                <div>
                                    <h4 class="text-xl font-semibold text-gray-800">Overzicht Allergenen</h4>
                                    <p class="text-gray-600 mt-1">Producten met allergenen en leveranciersinformatie</p>
                                </div>
                            </div>
                        </a>

                        <!-- Overzicht geleverde producten Link -->
                        <a href="{{ route('geleverde-producten.index') }}"
                           class="block p-6 bg-green-50 hover:bg-green-100 border border-green-200 rounded-lg transition-colors duration-200">
                            <div class="flex items-center">
                                ...
                                <div>
                                    <h4 class="text-xl font-semibold text-gray-800">Overzicht geleverde producten</h4>
                                    <p class="text-gray-600 mt-1">Geleverde producten binnen een tijdsvak</p>
                                </div>
                            </div>
                        </a>
